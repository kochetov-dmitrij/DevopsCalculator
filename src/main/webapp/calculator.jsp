        ...
        <form method="GET" action="calculate.html">
            <table border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><input type="submit" name="button" id="btn--" value="-"/></td>
                    <td class="empty"></td>
                    <td rowspan="2"><input class="double_height" type="submit" name="button" id="btn-=" value="="/>
                </tr>
                <tr>
                    <td colspan="2"><input class="double_width" type="submit" name="button" id="btn-0" value="0"/></td>
